// Last updated: 9/9/2026, 3:35:44 PM
1/**
...
61        // return true;
62
63        // ---------- solution 3 (in O(n) time and O(1) space) ----------
64
65        ListNode* i = head;
66        ListNode* j = head;
67
68        while (j -> next != NULL && j -> next -> next != NULL) {
69            i = i -> next;
70            j = j -> next -> next;
71        }
72        ListNode* mid = i;
73        ListNode* address = NULL;
74        i = i -> next;
75        // cout << address -> val;
76        
77        while(i != NULL){
78            ListNode* temp = i -> next;
79            i->next = address;
80            address = i;
81            i = temp;
82        }
